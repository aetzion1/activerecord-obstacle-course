...
# ----------------------
  ...
  it '5. finds multiple items by id' do
    ...
    items = Item.all.where(id: ids_to_find)
    # ------------------------------------------------------------
  ...
  it '6. finds multiple orders by id' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    items = Order.all.where(id: ids_to_find)
    # ------------------------------------------------------------
  ...
  it '7. finds orders with an amount between 700 and 1000' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    orders_between_700_and_1000 = Order.all.where(amount: [700..1000])
    # ------------------------------------------------------------
  ...
  it '8. finds orders with an amount less than 550' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    orders_less_than_550 = Order.all.where("amount < 550")
    # ------------------------------------------------------------
